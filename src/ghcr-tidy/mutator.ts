...
import {
  ...
  type Requestable,
} from "../core/registry/packages.js";
import type { ApplyCapability } from "./apply-capability.js";

export type VersionId = number;
/** Reused verbatim from `core/registry/packages.ts` — see that module's doc for the undocumented 400-on-last-version behaviour this type encodes. Never reclassified here. */

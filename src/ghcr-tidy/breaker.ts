...
/** The subset of Octokit this module depends on — narrowed so it can be faked in tests, matching the style of `Requestable`/`Paginatable` in `core/registry/packages.ts`. */

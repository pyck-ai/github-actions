...
export type CheckExecutor<C extends Check = Check> = (check: C, index: number, ctx: CheckContext) => Promise<CheckResult>;
export declare function pass(index: number, kind: CheckKind, label: string): CheckResult;
export declare function fail(index: number, kind: CheckKind, label: string, detail?: string): CheckResult;
/**

...
;// CONCATENATED MODULE: ./src/core/registry/package-name.ts
...
;// CONCATENATED MODULE: ./src/core/registry/status.ts
...
;// CONCATENATED MODULE: ./src/core/registry/http.ts
...
;// CONCATENATED MODULE: ./src/core/registry/manifest.ts
...
;// CONCATENATED MODULE: ./src/core/registry/auth.ts
...
;// CONCATENATED MODULE: ./src/core/registry/packages.ts
...
;// CONCATENATED MODULE: ./src/core/registry/index.ts
...
;// CONCATENATED MODULE: ./src/core/registry/tags.ts
...
;// CONCATENATED MODULE: ./src/ghcr-tidy/domain.ts
/**
...
;// CONCATENATED MODULE: ./src/ghcr-tidy/adapters.ts
...
;// CONCATENATED MODULE: ./src/ghcr-tidy/mutator.ts
...
/**
 * The real, network-backed `Mutator`, wrapping `core/registry/packages.ts`.
...
;// CONCATENATED MODULE: ./src/ghcr-tidy/persisted-plan.ts
...
;// CONCATENATED MODULE: ./src/ghcr-tidy/apply-capability.ts
...
;// CONCATENATED MODULE: ./src/ghcr-tidy/incident-report.ts
/**
...
;// CONCATENATED MODULE: ./src/ghcr-tidy/breaker.ts
...
;// CONCATENATED MODULE: ./src/ghcr-tidy/journal.ts
 ...
 *
 * `packages[].match` is a FULL package name (`core/registry/package-name.ts`'s
...
;// CONCATENATED MODULE: ./src/ghcr-tidy/manifest/parse.ts
...
;// CONCATENATED MODULE: ./src/ghcr-tidy/retain.ts
...
;// CONCATENATED MODULE: ./src/ghcr-tidy/skip-reason.ts
...
;// CONCATENATED MODULE: ./src/ghcr-tidy/roots.ts
...
;// CONCATENATED MODULE: ./src/ghcr-tidy/reachability.ts
...
;// CONCATENATED MODULE: ./src/ghcr-tidy/plan.ts
...
;// CONCATENATED MODULE: ./src/ghcr-tidy/volume-alarm.ts
/**
...
;// CONCATENATED MODULE: ./src/ghcr-tidy/verify.ts
...
;// CONCATENATED MODULE: ./src/ghcr-tidy/apply.ts
...
async function applyPlan(plan, mutator, options) {
    ...
    if (verification) {
        const canaryOk = await checkCanary(verification.canary.path, verification.canary.tag, verification.registry);
        if (!canaryOk) {
            return {
                packages: [],
                attempted: 0,
...
;// CONCATENATED MODULE: ./src/ghcr-tidy/cli.ts
